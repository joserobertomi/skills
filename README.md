...
3. Run `/setup-matt-pocock-skills` in your agent. It will:
   ...
   - Ask you which language artifacts vs. conversation should use (`/english-artifacts` uses this)
...
- **[setup-matt-pocock-skills](./skills/engineering/setup-matt-pocock-skills/SKILL.md)** — Scaffold the per-repo config (issue tracker, triage label vocabulary, domain doc layout, artifact language) that the other engineering skills consume. Run once per repo before using `to-issues`, `to-prd`, `triage`, `diagnose`, `tdd`, `improve-codebase-architecture`, `zoom-out`, or `english-artifacts`.
